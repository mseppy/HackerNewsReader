...
{
    [TestClass]
    public class BestStoryServiceTests
    {
        ...
        [TestMethod]
        public void GetBestStories_NegativePassed_LogErrorReturnNothing()
        {
            // Arrange
            moqRepo.Setup(r => r.GetBestStoriesAsync(It.IsAny<int>())).ReturnsAsync(new List<Story>());

            // Act
            var result = storyService.GetBestStoriesAsync(-12);
        ...
        [TestMethod]
        public void GetBestStories_ZeroPassed_ReturnsDefault()
        {
            // Arrange
            var testStories = GenerateTestStories(storyService.DefaultItemsPerPage);
            moqRepo.Setup(r => r.GetBestStoriesAsync(It.IsAny<int>())).ReturnsAsync(testStories);

            // Act
            var result = storyService.GetBestStoriesAsync(0);
        ...
        [TestMethod]
        public void GetBestStories_ValidNumberPassed_Returns()
        {
            // Arrange
            ...
            // Act
            var result = storyService.GetBestStoriesAsync(storyCount);
